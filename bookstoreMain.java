...
public class bookstoreMain {
	...
	public static void main(String[] args) throws Exception {
		...
		// book name
		FileReader file = new FileReader("C:\\Users\\bhair\\Desktop\\DSA\\DSA MiniProject\\bname.txt");
		BufferedReader reader = new BufferedReader(file);

		// price
		FileReader file2 = new FileReader("C:\\Users\\bhair\\Desktop\\DSA\\DSA MiniProject\\bprice.txt");
		BufferedReader reader2 = new BufferedReader(file2);

		// quantity
		FileReader file3 = new FileReader("C:\\Users\\bhair\\Desktop\\DSA\\DSA MiniProject\\bquantity.txt");
			...
			if (id2.equals(id1) && pwd2.equals(pwd1)) {
				...
				while (!e2) {
					...
					case 1: // Generate bill method
						...
						System.out.println("Invoice no. " + Customer.bill_no + "\t\t\t" + formatter.format(date));
						Customer.bill_no++;
						System.out.println();
						...
						System.out.println("\n--------------------------------------------------------------");
						System.out.format("%-18s %15s %12s", "\tBooks", "Quantity", "Price");
						for (int d = 0; d < no; d++) {
							System.out.format("\n%-30s %7s %15s", buybook[d].bname, buybook[d].bquantity, buybook[d].bprice + "/-");
						}
						System.out.println("\n--------------------------------------------------------------");
						if (flag == 1) {
						...
						System.out.println();
						System.out.format("%-30s %7s %17s", "Total Bill:", countq, total + "/-");
						System.out.println("\n==============================================================");
						break;
